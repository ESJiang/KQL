...
export const kqlKeywords: Record<string, KqlKeyword> = {
    ...
    AccountSid: { type: "field", description: "The security identifier (SID) of the account involved in the event" },
    ...
    AdditionalFields: { type: "field", description: "Additional metadata fields associated with the email event" },
    ...
    FileSize: { type: "field", description: "The size of the file in bytes" },
    SHA256: { type: "field", description: "SHA-256 hash value of the file for integrity and identification" },
    ...
    InitiatingProcessAccountName: { type: "field", description: "InitiatingProcessAccountName field" },
    InitiatingProcessCommandLine: { type: "field", description: "InitiatingProcessCommandLine field" },
    ...
    DeviceId: { type: "field", description: "Unique identifier of the device where the event occurred" },
    InitiatingProcessId: { type: "field", description: "ID of the process that initiated the action or event" },
    InitiatingProcessCreationTime: { type: "field", description: "Timestamp when the initiating process was created" },
    ...
    FolderPath: { type: "field", description: "The full path of the folder where the file or event is located" },
